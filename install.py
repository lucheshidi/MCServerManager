...
> """
    if system_type == "isLinux":
        ...
        if result == "0":
            ...
            new_mirror = input("Please input new mirror: ")
            print("Not yet!")
            pass
        elif result == "5":
            print(f"""{GREEN}=================================
About script:
This script made by lucheshidi(https://github.com/lucheshidi/, https://lucheshidi.github.io/),
Don't distribute!!!
